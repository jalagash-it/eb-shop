      ...
      <div class="product__info">
        ...
        <div class="product__rating">
          ...
          <div class="product__rating-legend">
            <AppLink to="/"> {{ product.reviews }} Reviews </AppLink>
            <span>/</span>
            <AppLink to="/"> Write A Review </AppLink>
          </div>
        </div>
        ...
        <ul class="product__meta">
          ...
          <li>
            Brand:
            <AppLink to="/"> Wakita </AppLink>
          </li>
          <li>SKU: 83690/32</li>
        </ul>
        <template v-if="product && product.fields && product.fields.length">
          <hr />
          <div class="dynamic-fields">
            <p v-for="pair of product.fields" :key="pair.id">
              <b>{{ pair.key }}: </b> <b>{{ pair.val }}</b>
            </p>
          </div>
        </template>
      </div>
      ...
      <div class="product__sidebar">
        ...
        <form class="product__options">
          <div class="form-group product__option">
            <div class="product__option-label">Color</div>
          ...
          <div class="form-group product__option">
            <div class="product__option-label">Material</div>
          ...
          <div class="form-group product__option">
            ...
            <label for="product-quantity" class="product__option-label"
              >Quantity</label
            >
      ...
      <div class="product__footer">
        <div class="product__tags tags">
          <div class="tags__list">
            <AppLink to="/"> Mounts </AppLink>
            <AppLink to="/"> Electrodes </AppLink>
            <AppLink to="/"> Chainsaws </AppLink>
          </div>
        </div>
